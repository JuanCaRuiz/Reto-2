public class Modelo {
    ...
    public Modelo(String nombre, String apellidos, String fecha_nacimiento, String correo_institucional, String correo_personal, long celular, long numero_fijo, String programa) {
        this.nombre = nombre;
